<?php
 include $_SERVER["DOCUMENT_ROOT"] . "/bangiay_v2/admin/function/loaisanpham/loaisanpham.php";
?>
    ...
    <form action="" method="post">
      ...
      <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2" >
          ...
          <button type="submit" name="btn_capnhat" class="btn btn-primary" id="sualoaisp_capnhat_txt">CẬP NHẬT</button>
        </div>
      </div>
      </form>
    </div>
