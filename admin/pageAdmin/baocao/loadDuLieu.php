<?php
	include $_SERVER["DOCUMENT_ROOT"] . "/bangiay_v2/admin/function/baocao/baocao.php";
	include $_SERVER["DOCUMENT_ROOT"] . "/bangiay_v2/function/dbCon.php";
?>

<div class="row">

		<div class="col-sm-12" style="margin-top: 57px;padding-right: 25px;padding-left: 25px;">
			<div>
				<?php
