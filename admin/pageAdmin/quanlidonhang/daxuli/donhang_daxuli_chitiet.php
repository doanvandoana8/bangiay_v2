 <?php
 include $_SERVER["DOCUMENT_ROOT"] . "/bangiay_v2/admin/function/quanlidonhang/donhangdaxuli.php";
?>
<div class=row>
			...
			<div class="table-responsive cart_info">
				...
				<div class="payment-options" style="margin-bottom: 0px">
					<?php 
						...
						echo "class='btn btn-primary pull-right'  href='index.php?p=xacnhandonhangKHDXL&iddh=";
					...
					<?php 
						...
						echo "class='btn btn-primary pull-left'  href='index.php?p=huybodonhangKHDXL&iddh=";
