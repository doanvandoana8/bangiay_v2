...
<div class="modal-content">
		...
		<form action="" method="post">
			...
			<div class="col-xs-12 col-sm-6">
				<button style="width: 100%;margin-top: 5px;" type="submit" name="btn_CapNhat" class="btn btn-lg btn-info"> Cập nhật <span class="glyphicon glyphicon-saved"></span></button>
			</div>

			<div class="col-xs-12 col-sm-6">
				<button style="width: 100%;margin-top: 5px;"  type="submit" data-dismiss="modal" class="btn btn-lg btn-default" onclick="return confirm('Bạn có muốn hủy việc cập nhật?')" name="btn_huy"> Hủy <span class="glyphicon glyphicon-remove"></span></button>
			</div>
