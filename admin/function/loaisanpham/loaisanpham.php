<?php
	...
	{
		$qr="INSERT INTO `loaisanpham` (`id_loai_san_pham`, `ten_loai_san_pham`, `ngay_tao`, `nguoi_tao`, `ngay_cap_nhat`, `nguoi_cap_nhat`) VALUES (NULL, '$tenloai', CURRENT_DATE(), '$ten', '', 'Chưa cập nhật')";
		return mysql_query($qr);
	}
