<?php
	...
	{
		 $qr="INSERT INTO `sanpham` (`id_san_pham`, `ten_san_pham`, `id_loai_san_pham`, `anh_san_pham`, `thong_tin`, `san_pham_khuyen_mai`, `kinh_doanh`, `gia_ban_dau`, `gia_khuyen_mai`, `ngay_dang`, `size`, `so_luong`, `so_luot_mua`) VALUES (NULL, '$tensp', '$idloai', '$hinhanh', '$thongtin', '0', '$kinhdoanh', '$giaBD', '', CURDATE(), '$size', '$soluong', '');";
