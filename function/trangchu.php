<?php
	...
	function addNguoiDung($taikhoan,$hoten,$sodt,$matkhau,$diachi){
		$qr="
			INSERT INTO `nguoidung` (`id_nguoi_dung`, `tai_khoan`, `ho_ten`, `anh_nguoi_dung`, `gioi_tinh`, `so_dien_thoai`, `mat_khau`, `level`, `dia_chi`,`code`) 
			VALUES (NULL, '$taikhoan', '$hoten', '', '', '$sodt', '$matkhau', '0', '$diachi','');
		";
		return mysql_query($qr);
	}
	...
	function themDonHang($code,$taikhoan,$tenKH,$sodtKH,$emailKH,$diachiKH,$tenNN,$emailNN,$sodtNN,$diachiNN){
		 $qr="
			INSERT INTO `donhang` (`id_don_hang`, `code`, `tai_khoan`, `ten_khach_hang`, `so_dien_thoai_khach_hang`, `email_khach_hang`, `ngay_dat_hang`, `dia_chi_khach_hang`, `ten_nguoi_nhan`, `email_nguoi_nhan`, `so_dien_thoai_nguoi_nhan`, `dia_chi_nguoi_nhan`, `tong_tien`, `trang_thai`) VALUES (NULL, '$code', '$taikhoan', '$tenKH', '$sodtKH', '$emailKH',CURDATE(), '$diachiKH', '$tenNN', '$emailNN', '$sodtNN', '$diachiNN', '', 'dang_cho')
		";
		return mysql_query($qr);
	}
